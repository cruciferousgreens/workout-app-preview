...
/* ===== module: workout-history.js ===== */
    ...
    function finishWorkout() {
      ...
      if (!draft || !draft.exercises.length) { showToast('Add at least one exercise before finishing.','',6500); return; }
