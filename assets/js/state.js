...
const state = { query:'', muscles:new Set(), equipment:'', favorites:new Set(), onlyFavorites:false, onlyCustom:false, selected:null, customExercises:[], activeView:'dashboard', workoutDetailReturn:'workout', exerciseDetailReturn:null, dashboardPeriod:'week', statsPeriod:'week', topExercisesMode:'volume', showBlindspots:false, selectedDashboardDate:null, calendarWeekOffset:0, scroll:{dashboard:0, library:0, workout:0, program:0, stats:0, settings:0, detail:0} };
